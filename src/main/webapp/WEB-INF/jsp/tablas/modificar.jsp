<%--
    Document   : modificar
    Created on : 5/03/2019, 04:46:49 PM
    Author     : deivi
--%>
...
<body class="">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="modificaEmpleado" method="">
                <div class="card ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" type="text" name="nombre" required="true" value="${getNombre}" />
                        </div>
                      </div>
                      <label class="col-sm-2 col-form-label">Número de Seguro</label>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" value="${getNumSeguro}" type="text" name="numSeguro" required="true" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" name="ubicacion" id="ubicacion">
                            <option value="0" disabled="disabled">--Selecciona la ubicacion--</option>
                      ...
                      <div class="col-sm-3">
                        <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" name="puesto" id="puesto">
                          <option value="0" disabled="disabled">--Selecciona el puesto--</option>
                          <c:forEach items="${listaPuesto}" var="puesto">
                  ...
                  <div class="card-footer ml-auto mr-auto">
                    ...
                    <button type="submit" class="btn btn-rose btn-round " > Guardar</button>
                    <a class="btn btn-round " href="${pageContext.request.contextPath}/tablas/visualizar">Cancelar</a>
                  </div>
                </div>
              </form>
            </div>
  ...
  <script src="../complementos/assets/js/plugins/jasny-bootstrap.min.js"></script>
  ...
  <script>
    ...
    document.getElementById("puesto").value = ${getPuesto};
    document.getElementById("ubicacion").value = "${getUbicacion}";
