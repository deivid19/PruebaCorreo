<%--
    Document   : nuevo
    Created on : 5/03/2019, 12:01:02 PM
    Author     : deivi
--%>
...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/eclipse.png">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                  <a class="dropdown-item" href="${pageContext.request.contextPath}/">Salir</a>
                </div>
              </li>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="nuevoEmpleado" method="">
                <div class="card ">
                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <input class="form-control" type="text" name="numSeguro" required="true" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" title="Single Select" name="ubicacion">
                      ...
                      <div class="col-sm-3">
                        <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" title="Single Select" name="puesto">
                          <option disabled selected> Seleccionar </option>
                          <option value="2">Ingeniero de Campo</option>
                          <option value="3">Marketing</option>
                          <option value="4">Ventas</option>
                          <option value="5">Administración</option>
                          <option value="6">Operaciones</option>
                          <option value="7">Dirección de Desarrollo y Plataforma</option>
                          <option value="8">Auxiliar Administrativo</option>
                    ...
                    <div class="row">
                      ...
                      <div class='file-input'>
                        <input type='file'>
                          <h3>QR</h3>
                          <span class='button'>Buscar</span>
                          <span class='label' data-js-label>Archivo no Seleccionado</span>
                          </div>
                        </div>
                  ...
                  <div class="card-footer ml-auto mr-auto">
                    ...
                    <a href="visualizar.html">
                      <button type="submit" class="btn btn-round "> Cancelar</button>
                    </a>
                  </div>
                </div>
              </form>
